...
class Company_drive_schedule extends Frame implements ActionListener
{
    ...
    Company_drive_schedule()
    {
        ...
        but_back.setBounds(400, 775, 275, 30);
        but_save.setBounds(700, 775, 250, 30);
    ...
    public void actionPerformed(ActionEvent ae)
   {
        ...
        else if(ae.getSource()==but_save)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    bw.newLine();
                    JOptionPane.showMessageDialog(this, "Organised Data is added successfully.");
                }
    ...
    {
        Company_drive_schedule obj_dsf = new Company_drive_schedule();
