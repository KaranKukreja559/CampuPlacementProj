...
import javax.swing.*;
class Drive_Schedule_Form extends Frame implements ActionListener
{
    ...
    Drive_Schedule_Form()
    {
        ...
        try{
            bw = new BufferedWriter(new FileWriter("Drive_Schedule.txt"));
        }
    ...
    {
        Drive_Schedule_Form obj_dsf = new Drive_Schedule_Form();
