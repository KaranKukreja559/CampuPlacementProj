...
public class Placement_Reports_Module extends Frame implements ActionListener
{
    ...
    Button but3,but11, but12,but13, but21, but22,but23, but4, but5;
    Placement_Reports_Module()
    {
        ...
        lb4 = new Label("1. Confirmed Placement Drives Schedule Information Reports");
        lb5 = new Label("2. Organized Campus Drives Information Report");
        lb6 = new Label("3. Placement Drive Wise Conducted Rounds Information Report");
        lb7 = new Label("4. Placement Drive Wise Selected Students Information Report");
        lb8 = new Label("5. Back to Project Modules Form (Main Menu)");
        lb11 = new Label("Drive Type wise");
        lb12 = new Label("BatchYear wise");
        lb13 = new Label("Branch wise");
        lb21 = new Label("Drive Type wise");
        lb22 = new Label("BatchYear wise");
        lb23 = new Label("Branch wise");
        but11 = new Button("");
        but12 = new Button("");
        but13 = new Button("");
        but21 = new Button("");
        ...
        but12.setBounds(420, 290, 30, 30);
        lb12.setBounds(470, 290, 200, 30);
        but13.setBounds(690, 290, 30, 30);
        lb13.setBounds(740, 290, 325, 30);
        lb5.setBounds(100, 360, 700, 30);
        but21.setBounds(150, 400, 30, 30);
        lb21.setBounds(200, 400, 200, 30);
        but22.setBounds(420, 400, 30, 30);
        lb22.setBounds(470, 400, 200, 30);
        but23.setBounds(690, 400, 30, 30);
        lb23.setBounds(740, 400, 325, 30);
        lb6.setBounds(140, 470, 800, 30);
        but3.setBounds(100, 470, 30, 30);
        but4.setBounds(100, 540, 30, 30);
        lb7.setBounds(140, 540, 800, 30);
        but5.setBounds(100, 610, 30, 30);
        lb8.setBounds(140, 610, 700, 30);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
            new Year_ReportForm(3);
        }
        else if(ae.getSource() == but4)
        {
            new JobCompanies_Report();
        }
