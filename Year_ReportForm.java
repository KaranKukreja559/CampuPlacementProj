...
public class Year_ReportForm extends Frame implements ActionListener
{
    ...
    Year_ReportForm(int rep)
    {
        ...
        if(rep == 11)
            ...
            lb_title2 = new Label("BatchYear wise  Confirmed Placement Drives Schedule Information Reports");
        else if(rep == 22)
            lb_title2 = new Label("BatchYear wise Placed Students Information Reports");
        else if(rep == 31)
    ...
    {
        Year_ReportForm prf_obj = new Year_ReportForm();
