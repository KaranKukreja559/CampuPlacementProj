...
{
    Label lb_title, lb_empid, lb_studname, lb_batyear, lb_branch, lb_div, lb_rollno, lb_address, lb_gen, lb_mobileno, lb_email,  lb_hobbies, lb_expertarea, lb_awards;
    ...
    Plac_Registration_Form()
    {
        ...
        lb_empid = new Label("Student's PRN") ;
        ...
        lb_empid.setBounds(50, 250, 200, 30);
