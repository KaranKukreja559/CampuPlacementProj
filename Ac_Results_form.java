...
{
    Label lb_title, lb_empid, lb_s1, lb_s2, lb_s3, lb_s4, lb_s5, lb_s6, lb_back;
    ...
    Ac_Results_Form()
    {
        ...
        lb_s1.setBounds(200, 250, 275, 30);
        tf_s1.setBounds(525, 250, 200, 30);
        lb_s2.setBounds(200, 300, 275, 30);
        tf_s2.setBounds(525, 300, 200, 30);
        lb_s3.setBounds(200, 350, 275, 30);
        tf_s3.setBounds(525, 350, 200, 30);
        lb_s4.setBounds(200, 400, 275, 30);
        tf_s4.setBounds(525, 400, 200, 30);
        lb_s5.setBounds(200, 450, 275, 30);
        tf_s5.setBounds(525, 450, 200, 30);
        lb_s6.setBounds(200, 500, 275, 30);
        tf_s6.setBounds(525, 500, 200, 30);
        lb_back.setBounds(200, 550, 300, 30);
        tf_back.setBounds(525, 550, 200, 30);
        but_new.setBounds(100, 630, 250, 30);
        but_save.setBounds(400, 630, 250, 30);
        but_back.setBounds(700, 630, 250, 30);
        tf_studname.setBounds(200, 700, 400, 30);
