...
public class Students_Reports_Module extends Frame implements ActionListener
{
    ...
    Button but3,but11, but12, but21, but22, but4, but5;
    Students_Reports_Module()
    {
        ...
        lb3 = new Label("Students Placement Information Reports");
        lb4 = new Label("1. Placed Students Information Reports");
        lb5 = new Label("2. Non-Placed Students Information Reports");
        lb6 = new Label("3. Company Wise Placed Students Information Report");
        lb7 = new Label("4. Placement Summary Report");
