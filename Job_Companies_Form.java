...
public class Job_Companies_Form extends Frame implements ActionListener
{
   ...
   Job_Companies_Form()
   {
    ...
    lb_sname.setBounds(50,110,350,35);
    tf_sname.setBounds(450,110,250,30);
    lb_lname.setBounds(50,170,350,35);
    tf_lname.setBounds(450,170,250,30);
    lb_address.setBounds(50,230,300,35);
    tf_address.setBounds(450,230,250,30);
    lb_sector.setBounds(50,290,340,35);
    tf_sector.setBounds(450,290,240,30);
    lb_p1name.setBounds(50,350,340,35);
    tf_p1name.setBounds(450,350,250,30);
    lb_p1dg.setBounds(50,410,340,35);
    tf_p1dg.setBounds(450,410,250,30);
    lb_p1mobile.setBounds(50,470,240,35);
    tf_p1mobile.setBounds(300,470,240,30);
    lb_p1email.setBounds(600,470,150,35);
    tf_p1email.setBounds(780,470,240,30);
    lb_p2name.setBounds(50,530,340,35);
    tf_p2name.setBounds(450,530,250,30);
    lb_p2dg.setBounds(50,590,340,35);
    tf_p2dg.setBounds(450,590,250,30);
    lb_p2mobile.setBounds(50,650,240,35);
    tf_p2mobile.setBounds(300,650,240,30);
    lb_p2email.setBounds(600,650,150,35);
    tf_p2email.setBounds(780,650,240,30);
    
    but_add.setBounds(50,720,275,35);
    but_save.setBounds(390,720,325,35);
    but_back.setBounds(780,720,275,35);
    lb_id.setBounds(200, 800, 300, 30);
    tf_id.setBounds(550, 800, 100, 30);
