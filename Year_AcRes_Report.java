// Porgram to Produce Yearwise Registered Students Academic Results Report
import java.io.*;
public class Year_AcRes_Report
{
    
    Year_AcRes_Report(String yr)
    {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("AcResrep.html"));
            BufferedReader br = new BufferedReader(new FileReader("AcResults.txt"));
            BufferedReader br1;
            bw.write("<html>");
            bw.write("<body>");
            bw.write("<center><h1>PCCOER Ravet</h1></center>");     
            bw.write("<center><h1>BatchYear wise Students Academic Result Information Report</h1></center>");
            bw.write("<br>");
            ...
            rt.exec("Explorer AcResrep.html");
        }
