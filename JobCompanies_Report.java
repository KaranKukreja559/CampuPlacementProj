// Porgram to ProduceJob Companies Information Report
import java.io.*;
public class JobCompanies_Report
{
	...
	JobCompanies_Report()
    {
        try{
            ...
            bw.write("<th>Company Short Name</th>");
            bw.write("<th>Company Full Name</th>");
            ...
            rt.exec("Explorer JobComrep.html");
        }
