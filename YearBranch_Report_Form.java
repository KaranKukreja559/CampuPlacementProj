...
public class YearBranch_Report_Form extends Frame implements ActionListener
{
    ...
    YearBranch_Report_Form(int rep)
    {
        ...
        if(rep == 11)
            ...
            lb_title2 = new Label("BatchYear, Branch wise Confirmed Placement Drives Schedule Information Reports");
        else if(rep == 22)
            lb_title2 = new Label("BatchYear, Branch wise Placed Students Information Reports");
        else if(rep == 31)
            lb_title2 = new Label("BatchYear, Branch wise Non-Placed Students Information Reports");
        else if(rep == 32)
            lb_title2 = new Label("BatchYear, Branch wise Certified Courses Information Report");
