...
import javax.swing.*;
public class Counducted_Rounds_Data extends Frame implements ActionListener
{
   Label lb_title,lb_driveid,lb_date,lb_roundno,lb_roundtitle,lb_skills,lb_qualified,lb_empid, lb_comp;
   ...
   Counducted_Rounds_Data()
   {
    ...
    lb_empid=new Label("Qualified Students PRN");
    ...
    lb_empid.setBounds(50,650,450,35);
  ...
  void rounds_validate()
  {
   ...
   {
 Counducted_Rounds_Data obj=new Counducted_Rounds_Data();
